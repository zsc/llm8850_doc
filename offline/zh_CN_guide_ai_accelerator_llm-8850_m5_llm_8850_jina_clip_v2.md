...
来源: https://docs.m5stack.com/zh_CN/guide/ai_accelerator/llm-8850/m5_llm_8850_jina_clip_v2
...
git
clone
https://huggingface.co/AXERA-TECH/jina-clip-v2
...
python run_axmodel.py
运行结果：
(clip) m5stack@raspberrypi:~/rsp/jina-clip-v2 $ python3 run_axmodel.py -i beach1.jpg -t
"beautiful sunset over the beach"
-iax ./image_encoder.axmodel -tax ./text_encoder.axmodel --hf_path ./jina-clip-v2
...
unset
and a slow processor was saved with this model. `use_fast=True` will be the default behavior
in
v4.52, even
if
the model was saved with a slow processor. This will result
in
minor differences
in
outputs. You
'll still be able to use a slow processor with `use_fast=False`.
